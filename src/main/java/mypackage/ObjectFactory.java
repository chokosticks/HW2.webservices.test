...
public class ObjectFactory {
    ...
    private final static QName _AdditionResponse_QNAME = new QName("my.unique.keso", "additionResponse");
    private final static QName _Addition_QNAME = new QName("my.unique.keso", "addition");
     ...
     * 
     */
    @XmlElementDecl(namespace = "my.unique.keso", name = "additionResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "my.unique.keso", name = "addition")
