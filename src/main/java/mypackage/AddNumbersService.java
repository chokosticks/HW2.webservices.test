 ...
 * 
 */
@WebServiceClient(name = "AddNumbersService", targetNamespace = "my.unique.keso", wsdlLocation = "http://0.0.0.0:12345/AddNumbers?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ADDNUMBERSSERVICE_QNAME = new QName("my.unique.keso", "AddNumbersService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://0.0.0.0:12345/AddNumbers?wsdl");
    ...
    public AddNumbers getAddNumbersPort() {
        return super.getPort(new QName("my.unique.keso", "AddNumbersPort"), AddNumbers.class);
    }
    ...
    public AddNumbers getAddNumbersPort(WebServiceFeature... features) {
        return super.getPort(new QName("my.unique.keso", "AddNumbersPort"), AddNumbers.class, features);
    }
